...
export function Contact() {
    ...
    return (_jsx("section", { id: "project-brief", className: "px-6", style: {
            padding: '96px 24px',
                                ...
                                color: 'var(--text-muted)',
                                maxWidth: '480px',
                            }, children: locale === 'en' ? 'Reply within one business day. NDA on request.' : 'מענה תוך יום עסקים. הסכם סודיות זמין לפי הצורך.' })] }), _jsxs("div", { className: "grid md:grid-cols-3 gap-8", children: [_jsxs("a", { ref: (el) => {
                                if (el)
                                    cardsRef.current[0] = el;
                            }, href: whatsappLink, target: "_blank", rel: "noopener noreferrer", className: "group transition-all duration-300 flex flex-col contact-card", style: {
                                ...
                                e.currentTarget.style.transform = 'translateY(0) scale(1)';
                                        ...
                                        fontWeight: 600,
                                        color: '#0070f3',
                                    }, children: [locale === 'en' ? 'Message on WhatsApp' : 'שלחו הודעה ב-WhatsApp', " \u2192"] })] }), _jsxs("a", { ref: (el) => {
                                if (el)
                                    cardsRef.current[1] = el;
                            }, href: "https://t.me/Flowlytic_bot", target: "_blank", rel: "noopener noreferrer", className: "group transition-all duration-300 flex flex-col contact-card", style: {
                                background: 'var(--surface)',
                                border: '1px solid var(--border)',
                                borderRadius: '7px',
                                padding: '24px',
                                ...
                                e.currentTarget.style.transform = 'translateY(0) scale(1)';
                                        ...
                                        fontWeight: 600,
                                        color: '#0070f3',
                                    }, children: [locale === 'en' ? 'Message on Telegram' : 'שלחו הודעה בטלגרם', " \u2192"] })] }), _jsxs("div", { ref: (el) => {
                                if (el)
                                    cardsRef.current[2] = el;
                            }, className: "contact-card", style: {
                                background: 'var(--surface)',
                                border: '1px solid var(--border)',
                                borderRadius: '7px',
                                padding: '24px',
                                ...
                                e.currentTarget.style.transform = 'translateY(0) scale(1)';
                                        ...
                                        : 'שתפו את ההיקף ואחזור עם הצעת מחיר מותאמת.' }), _jsxs("form", { onSubmit: handleSubmit, style: { display: 'flex', flexDirection: 'column', gap: '12px' }, "aria-label": locale === 'en' ? 'Project brief form' : 'טופס תיאור פרויקט', children: [_jsx(Input, { name: "name", "aria-label": t.contact.form.name, placeholder: t.contact.form.name, value: formData.name, onChange: (e) => setFormData({ ...formData, name: e.target.value }), required: true }), _jsxs("div", { children: [_jsx(Input, { type: "email", "aria-label": t.contact.form.email, placeholder: t.contact.form.email, value: formData.email, onChange: (e) => {
